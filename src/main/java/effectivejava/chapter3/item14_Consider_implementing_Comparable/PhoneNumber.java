package effectivejava.chapter3.item14_Consider_implementing_Comparable;
import java.util.*;
...
public final class PhoneNumber implements Cloneable, Comparable<PhoneNumber> {
    ...
    @Override public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof effectivejava.chapter3.item11_Always_override_hashCode_when_you_override_equals.PhoneNumber))
            return false;
