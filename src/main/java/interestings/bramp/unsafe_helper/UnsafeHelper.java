package interestings.bramp.unsafe_helper;

import interestings.bramp.common.Preconditions;
...
public class UnsafeHelper {
    ...
    public static long headerSize(Class clazz) {
        ...
        // TODO Should be calculated based on the platform (varies based on CPU architecture)
