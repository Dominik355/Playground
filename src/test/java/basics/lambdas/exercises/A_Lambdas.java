...
public class A_Lambdas {
    ...
    public void a_predicate2() {
        Predicate<String> pred = str -> str == null || str.isEmpty();
    ...
    public void c_consumer1() {
        Consumer<StringBuilder> cons =  strb -> strb.append("abc");
    ...
    public void g_boundMethodRef1() {
        Function<String, Integer> func = str -> "abcdefghij".indexOf(str);
    ...
    public void g_boundMethodRef2() {
        ...
        // this gives us in this case IndexOf method for particular string instance
        // to jhave it generic, use bifunction (String, String, Integer)
    }
