...
public class C_DefaultMethods {
    ...
    public void c02_removeOddLengthWords() {
        ...
        // second option - AND on last bit - if its there, its odd
    ...
    public void c06_mapOfListOfStringsByLength() {
        ...
        list.forEach(s -> result
                            .computeIfAbsent(s.length(), key -> new ArrayList<>())
                            .add(s)
        );
    ...
    public void c07_mapOfStringByInitialCharacter() {
        ...
        list.forEach(element -> result.merge(element.charAt(0), element, (oldE, newE) -> oldE + ":" + newE));
    ...
    public void c10_mapReplaceEmptyValues() {
        ...
        map.replaceAll((key, value) -> value.equals("") ? key : value);
    ...
    public void c11_computeWithMissingEntries() {
        ...
        keys.forEach(key -> map.compute(key, (k, v) -> (v == null || v.isEmpty()) ? k : v.toUpperCase()));
